...
<Screens ids="scan-mobile,wheel-mobile,ticket-mobile" caption="What the customer sees between the plate and the counter: the three steps, the wheel, the ticket to be validated." />
...
<Screen id="admin-system" caption="The super-admin control centre: uptime, latency, service status and live console." />
