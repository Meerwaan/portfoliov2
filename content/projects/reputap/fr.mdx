...
<Screens ids="scan-mobile,wheel-mobile,ticket-mobile" caption="Ce que voit le client entre la plaque et la caisse : les trois étapes, la roue, le ticket à faire valider." />
...
<Screen id="admin-system" caption="Le centre de contrôle super-admin : uptime, latence, statut des services et console temps réel." />
