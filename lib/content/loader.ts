...
/** The stack changelog (content/about/stack.json). */
export async function getStackLog(): Promise<StackLogData> {
  return readJson(path.join(CONTENT, "about", "stack.json"), StackLogData);
}
